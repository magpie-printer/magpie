...
## DO NOT USE LINEAR BEARINGS FOR THE Z-AXIS RODS AS THEY WILL CAUSE BINDING, BUT YOU STILL NEED THE RODS THEMSELVES FOR STRUCTURE.
IN FACT DON'T EVEN USE THE BEARING CLAMPS

# Bill of Materials:


Non-printed parts:
 - Z motors w/ 400mm integrated leadscrews **x3**
 (that's the 1 the vanilla uses + the 2 this mod uses for a total of 3)
 - M3x14 Socket Cap Screw ***x8***
 - Laser cut acrylic bottom panel (independent motor version) ***x1***
